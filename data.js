	...
	AMERICAN_GOVERNMENT: {
		...
		'C: Rights and Responsibilities': [
			...
			},
			{
				...
				answer: ['vote', 'join a political party', 'run for office'],
			},
			{
				number: 56,
	...
	AMERICAN_HISTORY: {
		'A: Colonial Period and Independence': [
			...
			},
			{
				...
				answer: ['New Hampshire', 'New York', 'New Jersey', 'Pennsylvania', 'North Carolina', 'South Carolina'],
			},
			{
				number: 65,
			...
			},
			{
				...
				answer: ['U.S. diplomat', 'started the first free libraries'],
			},
			{
				number: 69,
	...
	INTEGRATED_CIVICS: {
		'A: Geography': [
			...
			},
			{
				...
				answer: ['New York', 'Washington', 'Alaska'],
			},
			{
				number: 93,
		...
		'C: Holidays': [
			...
			},
			{
				...
				answer: ['Presidents’ Day', 'Memorial Day', 'Independence Day', 'Labor Day', 'Thanksgiving', 'Christmas'],
			},
		],
	},
};
